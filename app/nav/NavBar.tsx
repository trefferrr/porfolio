...
const NavBar = () => {
  return (
    <div
      className={`${styles.navbar} flex   justify-between my-3 md:my-4 px-[1rem] sm:px-[1.5rem] lg:px-[4rem]`}
    >
      ...
      <div className="flex gap-7  relative">
         <DarkModeSwitch />
        <a className="text-sm mr-1 relative" href="/resume">
          <span>
            <span className="font-extrabold opacity-95">Resume</span>
        ...
        <a className="text-sm mr-1 relative" href="mailto:aditya4901j@gmail.com">
          <span>
